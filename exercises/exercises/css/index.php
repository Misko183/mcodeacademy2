...
<body style="border-top-style: none;">
    ...
    <div class="row g-0">
        ...
        <div class="col-xxl-8" style="margin-left:25px;margin-top:50px;">
            <h1>Cvičenie:</h1>
            <p>Nastavte farbu všetkých prvkov &lt;p&gt; na červenú.</p>
          ...
          ">
                ...
                <p>
                    &lt;style&gt;<br>
                    <input type="text" name="answer" style="max-width: 20px;"> {<br>
                    ...
                    <p id="correct_answer" style="display: none;">Správna odpoveď je <code>p a color:</code></p>
            </div>
            </form>
            <?php
  if (isset($_POST['submit'])) {
    ...
    if ($answer == "p" && $answer2 == "color:") { echo "
