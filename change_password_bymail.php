...
<body>
    ...
    <section>
        ...
        <div class="login-box">
            <h2>Zmena hesla <span style="font-size: 16px;"><?php echo $email ?></span></h2>
            <?php
                    if(isset($message)){
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <p style="margin-bottom: 0px;">Ešte nemáš účet?<span><a href="register.php"> Zaregistruj sa</a></span>
                </p>
                <p style="margin-top: 0px;">Máš účet?<span><a href="login.php"> Prihlás sa</a></span></p>
