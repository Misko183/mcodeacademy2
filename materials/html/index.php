...
<head>
    ...
    <title>Domov HTML | McodeAcademy</title>
...
<body>
    ...
    <div class="row g-0">
                        ...
                        <ul class="navbar-nav flex-column" style="color: var(--bs-white);width: 100%;">
                            ...
                            <li class="nav-item" style="color: var(--bs-gray-400);">
                                <a class="nav-link active" href="index.php"
                                    style="color: rgb(227, 76, 38);font-weight: bold;">HTML Domov<i class="fas fa-star"
                                        style="color: var(--bs-yellow);margin-left: 4px;"></i></a>
                            </li>
                            <li class="nav-item" style="color: var(--bs-gray-400);"><a class="nav-link active"
                                    href="uvod.php" style="color: var(--bs-white);">HTML Úvod</a></li>
                            <li class="nav-item" style="color: var(--bs-gray-400);"><a class="nav-link active"
        ...
        <div class="col-md-8 col-lg-9 col-xl-9 col-xxl-9 content"
            ...
            <h1 class="text-start" style="font-weight: bold;margin-bottom: 36px;">HTML tutoriál</h1>
            <div>
                <div class="container">
