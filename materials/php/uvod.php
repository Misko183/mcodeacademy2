...
<?php include 'template/nav.php' ?>
    <div class="row g-0">
                ...
                <div class="container-fluid"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1" style="color: var(--bs-gray-300);"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1" style="width: 100%;">
                        <ul class="navbar-nav flex-column" style="color: var(--bs-white);width: 100%;">
                            ...
                            <li class="nav-item" style="color: var(--bs-gray-400);"><a class="nav-link active" href="#" style="color: var(--bs-white);">Domov PHP</a></li>
                            <li class="nav-item" style="color: var(--bs-gray-400);"><a class="nav-link active" href="#" style="color: #797ab2;font-weight: bold;">Úvod do PHP<i class="fas fa-star" style="color: var(--bs-yellow);margin-left: 4px;"></i></a></li>
        ...
        <div class="col-md-8 col-lg-9 col-xl-9 col-xxl-9 text-center" style="margin-left: 0px;padding-right: 15px;padding-left: 15px;">
            ...
            <div>
                <div class="container">
                    <div class="row g-0" style="margin-bottom: 27px;">
                        <div class="col-sm-7 col-md-8" style="text-align: left;"><a href="#" style="letter-spacing: 3px;color: var(--bs-cyan);background: #212529;padding: 15px;border-radius: 15px;font-size: 24px;"><i class="fas fa-angle-left" style="font-size: 24px;margin-top: 0px;margin-right: 5px;"></i>Predchádzajúce</a></div>
            ...
            <p style="text-align: left;">Skôr ako budete pokračovať, mali by ste mať základné znalosti o nasledujúcich veciach:</p>
            <ul>
                <li style="text-align: left;">HTML</li>
                <li style="text-align: left;">CSS</li>
                <li style="text-align: left;">JavaScript</li>
            </ul>
            <p style="text-align: left;">Ak chcete najskôr študovať HTML a CSS, návody nájdete na našej domovskej stránke.</p>
            <hr>
            ...
            <div style="background: rgba(13,202,240,0.48);padding: 27px;border-radius: 19px;">
                <h5 style="text-align: left;font-weight: bold;margin-bottom: 15px;">PHP je úžasný a popúlarný jazyk!</h5>
                <p style="text-align: left;margin-bottom: 0;">Je dostatočne výkonný na to, aby bol jadrom najväčšieho blogovacieho systému na webe (WordPress)!</p>
                <p style="text-align: left;margin-bottom: 0;">Je dostatočne hlboký na to, aby prevádzkoval veľké sociálne siete!</p>
                <p style="text-align: left;margin-bottom: -50px;">Je tiež dosť jednoduché byť prvým jazykom na strane servera pre začiatočníkov! <br><br><br></p>
            </div>
            <hr>
            ...
            <p style="text-align: left;">S PHP nie ste obmedzený na výstup HTML. Môžete vydávať obrázky alebo súbory PDF. Môžete tiež vytlačiť ľubovoľný text, napríklad XHTML a XML. </p>
            <hr>
