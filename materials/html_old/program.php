    ...
    <div class="row">
                ...
                <div class="container-fluid" style="padding-right: 0;">
                    <div class="collapse navbar-collapse " id="navcol-1">
                        ...
                        <li class="nav-item"><h5>HTML základ</h5></li>
                            ...
                            <li class="nav-item" style="background-color:rgb(172, 172, 172);padding-left: 8px; padding-top: 5px;padding-bottom: 5px;">HTML Program</li>
        ...
        <div class="col-md-6" style="width: 80%;margin-left: 15%;z-index:0;">
            <div class="content">
                <div class="title">
                    <h5>HTML programy</h5>
                    <p>Klasický textový program je všetko čo potrebuješ na naučenie sa HTML.</p>
                </div>
                <div class="first">
                    <h5>Nauč sa HTML používaním Notepadu (PC)</h5>
                    <p>Windows 8 ale novší:</p>
                    <ol>
                        <li>Otvor si úvodnú obrazovku (windows znak na spodku obrázovky)</li>
                        <li>Napíš Notepad</li>
                        <li>Otvor prográm kliknutím</li>
                    </ol>
                </div>
                <div class="second">
                    <h5>Napíš doň nejaké HTML</h5>
                    <p>Napíšte alebo skopírujte nasledujúci HTML kód do programu Poznámkový blok:</p>
                    <p>&lt;!DOCTYPE html&gt;</p>
                    <p>&lt;html&gt;</p>
                    <p>&lt;body&gt;</p>
                    <p>&lt;h1&gt;MCodeAcademy HTML Tutoriál&lt;/h1&gt;</p>
                    <p>&lt;p1&gt;Tu sa naučíte všetko z HTML&lt;/p&gt;</p>
                    <p>&lt;/body&gt;</p>
                    <p>&lt;/html&gt;</p>

                    <img src="assets/img/notepad.png" alt="notepad">
                   
                </div>
                <div class="third">
                    <h5>Ulož HTML stránku</h5>
                    <p>Uložte súbor do vášho počítača. kliknite na<span>Súbor > Uložiť ako</span> vo vašom Notepad menu.</p>
                    <p>Pomenujte ho ako <span>index.html</span></p>
                    <img src="assets/img/save.png" alt="save">
                    
                </div>
                <div class="fourth">
                    <h5>Zobrazte vašu stránku v prehliadači.</h5>
                    <p>Otvorte uložený súbor HTML vo svojom obľúbenom prehliadači (dvakrát kliknite na súbor alebo kliknite pravým tlačidlom myši a vyberte možnosť „Otvoriť pomocou“).</p>
                    <p>Výsledok bude vyzerať asi takto:</p>
                    <img width="50%" src="assets/img/open.png" alt="open">
                </div>
