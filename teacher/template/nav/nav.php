    ...
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="../"><span
        ...
        <div class="collapse navbar-collapse flex-grow-0 order-md-first" id="navcol-6">
            <ul class="navbar-nav me-auto">
                ...
                ?>
                <li class="nav-item"><a class="nav-link active" href="../student/student.php" style="font-weight: bold;">Profil</a></li>
                <?php
                }
                ?>
                <?php 
        ...
        <div class="d-none d-md-block">
            <?php    
                $user = isset($_SESSION['user_type']) && isset($_SESSION["name"]);
            ...
            <?php
                    ...
                    <a class="btn btn-primary" role="button" data-bss-hover-animate="pulse"
                    href="../login.php?continue=<?php echo $link; ?>"
                    style="background: linear-gradient(0deg, #5b77e7 0%, #49b5d2 49%, #26e8a8 99%);color: rgb(254,254,254);font-weight: bold;border-width: 0px;border-radius: 11px;padding-right: 18px;padding-left: 18px;text-align: center;">Registrovať sa</a>
                <?php } ?>
