            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0"><?php echo $qry['quiz_name'] ?></h3><a
                    ...
                    <div class="d-xl-flex mx-auto align-items-xl-center" style="width: 50%;">
                        <button class="btn btn-primary d-flex mx-auto" type="button"
                            ...
                            data-bs-target="#add_question" data-bs-toggle="modal">
                            <i class="fas fa-plus-square" style="font-size: 24px;margin-right: 10px;"></i>
                            Pridať novú otázku
                        </button>
                        <button class="btn btn-primary d-flex mx-auto" type="button"
                            style="box-shadow: 4px 3px 7px 2px rgb(106,106,106);margin-bottom: 21px;"
                            data-bs-target="#add_student" data-bs-toggle="modal">
                            <i class="fas fa-plus-square" style="font-size: 24px;margin-right: 10px;"></i>
                            Pridať študenta/tku
                        </button>
                    </div>
					...
					?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../scripts/del_question.php?id=<?php echo $row['id']?>"
                                                    class="btn btn-primary" type="button"
					...
					?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../scripts/del_question_student.php?id=<?php echo $row['id']?>"
