                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Počet testov</span></div>
                                            <?php 
                                                include '../scripts/configa.php';
                                                $sql = "SELECT COUNT('1') FROM quiz_list";
                                                $result = mysqli_query($conn, $sql);
                                                $row = mysqli_fetch_array($result);
                                            ?>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo $row[0]; mysqli_close($mysqli);?></span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>Počet študentov</span></div>
                                            <?php 
                                                include '../scripts/configa.php';
                                                $sql = "SELECT COUNT('1') FROM users WHERE user_type = 'student'";
                                                $result = mysqli_query($conn, $sql);
                                                $row = mysqli_fetch_array($result);
                                            ?>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo $row[0]; mysqli_close($mysqli);?></span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span>Počet učiteľov</span></div>
                                            <?php 
                                                include '../scripts/configa.php';
                                                $sql = "SELECT COUNT('1') FROM users WHERE user_type = 'teacher'";
                                                $result = mysqli_query($conn, $sql);
                                                $row = mysqli_fetch_array($result);
                                            ?>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo $row[0]; mysqli_close($mysqli);?></span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Počet Adminov</span></div>
                                            <?php 
                                                include '../scripts/configa.php';
                                                $sql = "SELECT COUNT('1') FROM users WHERE user_type = 'admin'";
                                                $result = mysqli_query($conn, $sql);
                                                $row = mysqli_fetch_array($result);
                                            ?>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo $row[0]; mysqli_close($mysqli);?></span></div>
